...
public class UHCListeners implements Listener {
    ...
    public void onDeath(PlayerDeathEvent e) {
        for(Player pl : Bukkit.getOnlinePlayers()) {
            pl.getWorld().playSound(pl.getLocation(), Sound.ENTITY_WITHER_SPAWN, 3.0F, 1.0F);
        }
        ...
        if(main.isGameLaunch()) {
            ...
            if(commandsUHC.getNBTeams()<=1) {
                ...
                for(Player pl : Bukkit.getOnlinePlayers()) {
                    pl.getWorld().playSound(pl.getLocation(), Sound.ENTITY_WITHER_DEATH, 3.0F, 1.0F);
                }
    ...
    public void onBlockBreak(BlockBreakEvent e) {
        ...
        if(main.getConfigur().getBoolean("run.enableRun")) {
            ...
            //Tree Run Breaker :
            if( (b.getType() == Material.ACACIA_LOG) || (b.getType() == Material.BIRCH_LOG) || (b.getType() == Material.OAK_LOG) || (b.getType() == Material.DARK_OAK_LOG) || (b.getType() == Material.JUNGLE_LOG) || (b.getType() == Material.SPRUCE_LOG) )  {
                Vector<Block> arbre = getTree(b);
                for(Block bl : arbre) {
                    if( (bl.getType() == Material.ACACIA_LEAVES) || (bl.getType() == Material.BIRCH_LEAVES) || (bl.getType() == Material.OAK_LEAVES) || (bl.getType() == Material.DARK_OAK_LEAVES) || (bl.getType() == Material.JUNGLE_LEAVES) || (bl.getType() == Material.SPRUCE_LEAVES) ) {
    ...
    public void onCraft(CraftItemEvent e) {
        if(main.getConfigur().getBoolean("run.enableRun")) {
            ...
            if(e.getRecipe().getResult().equals(new ItemStack(Material.WOODEN_PICKAXE))) {
            ...
            if(e.getRecipe().getResult().equals(new ItemStack(Material.WOODEN_AXE))) {
    ...
    public void OnMobDeath(EntityDeathEvent e) {
        if(main.getConfigur().getBoolean("run.enableRun")) {
            if(e.getEntity() instanceof Pig) {
                e.getDrops().clear();
                e.getEntity().getLocation().getWorld().dropItem(e.getEntity().getLocation(), new ItemStack(Material.COOKED_PORKCHOP, 2));
            }
            ...
            if(e.getEntity() instanceof Sheep) {
                ...
                e.getEntity().getLocation().getWorld().dropItem(e.getEntity().getLocation(), new ItemStack(Material.WHITE_WOOL, 2));
    ...
    public Vector<Block> getTree(Block depart) {
        ...
        blocksautorise.add(Material.ACACIA_LOG);
        blocksautorise.add(Material.BIRCH_LOG);
        blocksautorise.add(Material.DARK_OAK_LOG);
        blocksautorise.add(Material.JUNGLE_LOG);
        blocksautorise.add(Material.OAK_LOG);
        blocksautorise.add(Material.SPRUCE_LOG);
        blocksautorise.add(Material.ACACIA_LEAVES);
        blocksautorise.add(Material.AZALEA_LEAVES);
        blocksautorise.add(Material.BIRCH_LEAVES);
        blocksautorise.add(Material.DARK_OAK_LEAVES);
        blocksautorise.add(Material.JUNGLE_LEAVES);
        blocksautorise.add(Material.OAK_LEAVES);
        blocksautorise.add(Material.SPRUCE_LEAVES);
